...
位于 [eplb_async_runtime.cpp](https://github.com/flytiger-eco/sglang-for-sail/blob/v0.5.18/python/sglang/kernels/jit/csrc/eplb/eplb_async_runtime.cpp)，是整个异步机制的核心。它包含：
...
位于 [eplb_async_host_mirror.py](https://github.com/flytiger-eco/sglang-for-sail/blob/v0.5.18/python/sglang/srt/eplb/eplb_async_host_mirror.py)，维护所有专家权重的 Host 侧副本。
...
位于 [eplb_manager.py](https://github.com/flytiger-eco/sglang-for-sail/blob/v0.5.18/python/sglang/srt/eplb/eplb_manager.py)，通过 Python generator 实现三阶段状态机：
...
位于 [expert_location_updater.py](https://github.com/flytiger-eco/sglang-for-sail/blob/v0.5.18/python/sglang/srt/eplb/expert_location_updater.py)，负责：
...
信号定义在 [eplb_async_signal_runtime.h](https://github.com/flytiger-eco/sglang-for-sail/blob/v0.5.18/python/sglang/kernels/jit/include/sgl_kernel/eplb_async_signal_runtime.h)：
