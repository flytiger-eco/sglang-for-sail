...
SGLang-for-SAIL is a PPU-adapted inference engine based on SGLang v0.5.12.
...
Before installing SGLang-for-SAIL v0.5.12, make sure the SAIL SDK and required runtime components are available in your environment.
...
```bash
pip install sglang==0.5.12 --force-reinstall --no-deps -i https://pkg.flytiger-eco.com/artifactory/api/pypi/pypi_index/simple
```
...
The command should print `0.5.12`.
