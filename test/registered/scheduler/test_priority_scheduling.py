...
register_ppu_ci(est_time=200, suite="nightly-1-ppu", nightly=True, disabled="PPU concurrent batching makes priority latency ordering unmeasurable (assertion flaky)")
