...
register_ppu_ci(est_time=30, suite="nightly-2-ppu", nightly=True, disabled="PPU does not support cuMemCreate multicast API (hgapiMulticastGetGranularity not implemented)")
