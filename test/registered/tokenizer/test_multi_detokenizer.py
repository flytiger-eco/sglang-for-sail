...
register_ppu_ci(est_time=350, suite="nightly-1-ppu", nightly=True, disabled="PPU Docker uvicorn too old: missing timeout_worker_healthcheck param for multi-worker mode")
