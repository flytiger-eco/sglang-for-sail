    ...
    def capture_one_shape(
        ...
        with forward_context(ForwardContext(attn_backend=attn_backend)):
            ...
            def run_once():
                ...
                # DSpark: call capture hooks to capture verification
                # epilogue results (accept/finalize) into the CUDA graph.
                for capture_hook in getattr(
                    self.model_runner, "capture_tail_hooks", []
                ):
